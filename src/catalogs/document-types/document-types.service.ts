...
export class DocumentTypesService {
  ...
  async create(createDocumentTypeDto: CreateDocumentTypeDto) {
    ...
    const entity = this.documentTypeRepository.create({
      ...
      kind: createDocumentTypeDto.kind,
    });
  ...
  async update(id: number, updateDocumentTypeDto: UpdateDocumentTypeDto) {
    ...
    Object.assign(dt, {
      ...
      kind: updateDocumentTypeDto.kind ?? dt.kind,
    });
  ...
  async bulkSoftDelete(ids: number[]) {
    ...
    return {
      ok: true,
      message: `${count} document types deleted successfully`,
    };
  }
  ...
  async restore(id: number) {
    ...
    return {
      ok: true,
      message: `Document type with id: ${id} restored successfully`,
    };
  }
